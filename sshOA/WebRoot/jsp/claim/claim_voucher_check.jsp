...
<body>
    <div class="action  divaction">
      ...
      <table width="90%" border="0" cellspacing="0" cellpadding="0" class="addform-base">
         ...
         <tr>
           <td width="27%"><s:property value="#checkResult.checkEmployee.name" />(<s:property value="#checkResult.checkEmployee.position.nameCn" />)</td>
		...
		<tr>
		 ...
		 <tr>
			<td colspan="3" class="submit">
				...
				<s:hidden id="claimId" name="claimVoucher.id" value="%{claimVoucher.id}"/>
				<s:hidden id="result" name="checkResult.result" value=""/>
				<s:if test='#session.emp.position != "财务"'>
