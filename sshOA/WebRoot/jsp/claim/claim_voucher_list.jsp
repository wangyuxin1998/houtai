...
<div class="action  divaction">
	...
	<div class="pages">
		<div class="forms">
			 <s:form action="claimVoucher_searchClaimVoucher.action" name="queryForm">
	       		<label>报销单状态</label>
	  			<s:select name="status" list="statusMap" 
	...
	<s:form action="claimVoucher_searchClaimVoucher.action" name="claimVoucherForm">
		<table width="90%" border="0" cellspacing="0" cellpadding="0" class="list items">
	      ...
	      <s:iterator value="pageSupport.list" id="claimVoucher" begin="0" status="s">
	      <tr>
	        ...
	        <td>
		        ...
		        <s:if test="#claimVoucher.sysEmployeeByNextDealSn.name == #session.emp.name">
	      ...
	      <tr>
	        <td colspan="6" align="center">
				...
				<c:param name="totalPageCount" value="${pageSupport.totalPage}"/>
